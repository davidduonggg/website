...
export function SignalField() {
  ...
  useEffect(() => {
    ...
    for (let index = 0; index < 3200; index += 1) {
      ...
      const sparkle = starRandom() > 0.9;
      const shade = white.clone().lerp(smoke, sparkle ? starRandom() * 0.12 : 0.14 + starRandom() * 0.34);
    ...
    const render = () => {
      ...
      starMaterial.opacity = 0.9 + Math.sin(frame * 0.9) * 0.05;
